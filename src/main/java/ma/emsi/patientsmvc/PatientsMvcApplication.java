...
public class PatientsMvcApplication {
    ...
    CommandLineRunner saveUsers(SecurityService securityService){
        return args -> {
            securityService.saveNewUser("driss","1234","1234");
            securityService.saveNewUser("Maldi","1234","1234");
            securityService.saveNewRole("USER","");
            securityService.saveNewRole("ADMIN","admin");

            securityService.addRoleToUser("driss","ADMIN");
            securityService.addRoleToUser("driss","USER");
            securityService.addRoleToUser("maldi","USER");
